...
copy /b bbcb\os12.rom +bbcb\swmmfs2.rom +bbcb\ram_master_v6.rom +bbcb\basic2.rom +bbcb\Acorn-DFS-2.26.rom +m128\mammfs2.rom +m128\mos.rom +m128\dfs.rom +m128\viewsht.rom +m128\edit.rom +m128\basic4.rom +m128\adfs.rom +m128\view.rom +m128\terminal.rom +bbcb\swmmfs2v2.rom +m128\mammfs2v2.rom rom.bin 


srec_cat.exe rom.bin -binary -o rom.mif -mif 8
pause
