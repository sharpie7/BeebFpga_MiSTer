...
rem copy /b bbcb\os12.rom +bbcb\swmmfs.rom +bbcb\ram_master_v6.rom +bbcb\basic2.rom +m128\adfs1-57.rom +m128\mammfs.rom +m128\mos.rom +m128\dfs.rom +m128\viewsht.rom +m128\edit.rom +m128\basic4.rom +m128\adfs.rom +m128\view.rom +m128\terminal.rom rom.bin
srec_cat.exe rom.bin -binary -o rom.mif -mif 16
pause
